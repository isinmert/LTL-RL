...
class GridWorldEnv(gym.Env):
    ...
    def __init__(self, params=None):
        ...
        self.seed = get_param(self.params, GridWorldEnv.RANDOM_SEED_FIELD)

        # state properties
        self.hide_state_variables = get_param(self.params, GridWorldEnv.HIDE_STATE_VARIABLES, False)
        self.use_one_hot_vector = get_param(self.params, GridWorldEnv.USE_ONE_HOT_VECTOR_FIELD, False)
